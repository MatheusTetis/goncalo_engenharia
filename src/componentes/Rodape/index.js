...
const Rodape = (props) => {
    ...
    return (
        <footer>
            ...
            <Container>
                <div>
                    <Texto nomeDaClasse="pequeno">
                        © {Ano}  Gonçalo Engenharia EIRELI.  27.502.500/0001-88<br />
                        Rua Quinto do Sol, 33 - São Paulo, SP - 03818-140<br />
                        Rua Victoria Simionato, 659 - São Paulo, SP - 03808-170
                    </Texto>
                </div>
                <div className="rede-social">
                    <a href="https://www.linkedin.com/in/keyni-william-de-oliveira-028244132/" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 21 20" className="sc-UnBNk iEycqr" color="white" role="img">
                    ...
                    <a href="https://www.facebook.com/goncaloengenharia/" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 21 20" className="sc-UnBNk iEycqr" color="white" role="img">
...
<a href="#" target="_blank" rel="noopener">
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 21 20" className="sc-UnBNk iEycqr" color="white" role="img">
        ...
        <g>
            <path d="M10.5 7C8.84315 7 7.5 8.34315 7.5 10C7.5 11.6569 8.84315 13 10.5 13C12.1569 13 13.5 11.6569 13.5 10C13.5 8.34315 12.1569 7 10.5 7Z" fill="#111111"></path>
            <path fillRule="evenodd" clipRule="evenodd" d="M0.935974 2.18404C0.5 3.03969 0.5 4.15979 0.5 6.4V13.6C0.5 15.8402 0.5 16.9603 0.935974 17.816C1.31947 18.5686 1.93139 19.1805 2.68404 19.564C3.53969 20 4.65979 20 6.9 20H14.1C16.3402 20 17.4603 20 18.316 19.564C19.0686 19.1805 19.6805 18.5686 20.064 17.816C20.5 16.9603 20.5 15.8402 20.5 13.6V6.4C20.5 4.15979 20.5 3.03969 20.064 2.18404C19.6805 1.43139 19.0686 0.819467 18.316 0.435974C17.4603 0 16.3402 0 14.1 0H6.9C4.65979 0 3.53969 0 2.68404 0.435974C1.93139 0.819467 1.31947 1.43139 0.935974 2.18404ZM16.5417 5.08333C17.117 5.08333 17.5833 4.61696 17.5833 4.04167C17.5833 3.46637 17.117 3 16.5417 3C15.9664 3 15.5 3.46637 15.5 4.04167C15.5 4.61696 15.9664 5.08333 16.5417 5.08333ZM5.5 10C5.5 7.23858 7.73858 5 10.5 5C13.2614 5 15.5 7.23858 15.5 10C15.5 12.7614 13.2614 15 10.5 15C7.73858 15 5.5 12.7614 5.5 10Z" fill="#111111"></path>
        </g>
    </svg>
</a>
<a href="#" target="_blank" rel="noopener">
